													...
													<div class="col-lg-10">
														<div class="form-group"> <br>
															...
															?>
																	...
																	<td width="10%" align="center">
																		<font color="black" size="3px" class="serif"> ดูตารางสอน </font>
																	...
																	<tr>
																		...
																		<td rowspan="2"> <a style="color: green;" class="btn btn-outline-success ml-2" href="<?php echo "/college5/steacher/view_subject3.php?CusID=" . $_GET['CusID'] . '&sec=' . $objResult_sec['data14']; ?>">ดูเวลา</a> </td>
													...
													<div class="col-lg-7" style="margin-top: 10px; margin-bottom: 10px; ">
														<table width="100%" border="0">
															...
															<tr>
																<!-- <td width="60%">
																	<div class="mt-3">
																		<font size="3px" color="black"> &nbsp; GPA ของรายวิชา <?php echo $data1 . " - " . $data2 . " ที่เคยได้"; ?> </font>
																	</div>
																</td> -->
																<td>
																	<div class="mt-3">
																		<!-- <input required type="text" placeholder="" value="" name="grade" class="form-control " autocomplete="off" style=" border-radius: 10px;"> -->
																	</div>
																</td>
																<td>
																	<div>
